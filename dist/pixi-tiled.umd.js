...
(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@pixi/display'), require('@pixi/math'), require('@pixi/core'), require('@pixi/sprite'), require('@pixi/sprite-animated'), require('@pixi/graphics'), require('@pixi/text'), require('@pixi/utils'), require('@pixi/assets')) :
	typeof define === 'function' && define.amd ? define(['exports', '@pixi/display', '@pixi/math', '@pixi/core', '@pixi/sprite', '@pixi/sprite-animated', '@pixi/graphics', '@pixi/text', '@pixi/utils', '@pixi/assets'], factory) :
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.pixiv_tiled = {}, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI, global.PIXI.utils, global.PIXI));
})(this, (function (exports, display$1, math, core, sprite, spriteAnimated, graphics, text, utils, assets) { 'use strict';
